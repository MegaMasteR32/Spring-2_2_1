...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        userService.add(new User("User2", "Lastname2", "user2@mail.ru", new Car("Fiat", 500)));
        userService.add(new User("User3", "Lastname3", "user3@mail.ru", new Car("Mercedes", 600)));
        userService.add(new User("User4", "Lastname4", "user4@mail.ru", new Car("Tank", 300)));
        userService.add(new User("User5", "Lastname5", "fhevgvv@mail.ru", new Car("BMW", 5)));
